...
%  [SubjectID,Age,Gender,Weight,Day1,Day2,Day3] = IMPORTFILE(FILENAME) reads data from text file
%  FILENAME for the default selection.  Returns the data as a table.
%
%  [SubjectID,Age,Gender,Weight,Day1,Day2,Day3] = IMPORTFILE(FILE, DATALINES) reads data for the
%  specified row interval(s) of text file FILENAME. Specify DATALINES as
%  a positive scalar integer or a N-by-2 array of positive scalar
%  integers for dis-contiguous row intervals.
%
%  Example:
%  [SubjectID,Age,Gender,Weight,Day1,Day2,Day3] = importfile("C:\Users\jbarr\Documents\isok_data_6803.csv", [2, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 29-Oct-2023 18:51:26
